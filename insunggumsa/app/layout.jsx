...
export const metadata = {
  metadataBase: new URL("https://insungtest-korea.vercel.app"),
  ...
  openGraph: {
    ...
    type: "website",
    locale: "ko_KR",
    url: "https://insungtest-korea.vercel.app",
  },
  // 검색엔진 소유권 확인 — 가입 후 발급된 코드로 교체하세요
  verification: {
    google: "GOOGLE_SEARCH_CONSOLE_CODE", // Google Search Console에서 발급
    other: {
