...
const PUBLISHER_ID = "ca-pub-YOUR_PUBLISHER_ID"; // ← 교체 필요
const AD_SLOT     = "YOUR_AD_SLOT_ID";           // ← 교체 필요
...
export default function AdUnit({ style }) {
  ...
  // Publisher ID 미설정 시 빈 박스 렌더 (개발 중 레이아웃 확인용)
  if (PUBLISHER_ID.includes("YOUR")) {
    return (
      <div style={{
