...
function ScoreBar({ dim, score }) {
  ...
  const grade = pct >= 70 ? "높음" : pct >= 40 ? "보통" : "낮음";
  return (
    <div style={{ marginBottom: 18 }}>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8, alignItems: "center" }}>
        <div>
          <span style={{ color: "#CBD5E1", fontSize: 14, fontWeight: 600 }}>{meta.label}</span>
          <span style={{ color: "#475569", fontSize: 12, marginLeft: 8 }}>{meta.desc}</span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ color: "#94A3B8", fontSize: 13, fontWeight: 700 }}>{score.toFixed(1)}</span>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
            <div>
              <div style={{ color: "#94A3B8", fontSize: 12, marginBottom: 4 }}>응답 신뢰도</div>
